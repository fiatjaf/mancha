...
func ensurePersonMetadataIsCached(pubkey string, currentRelay string) (wasCached bool, isCachedNow bool) {
	_, wasCached = people.LoadOrCompute(pubkey, func() *sdk.ProfileMetadata {
